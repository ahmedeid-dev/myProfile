...
export default function page() {
  return <>
    <div className='text-center text-capitalize'>
      <h2>bookmark</h2>
      <p className=''> My Seventh && Second Java Script Web Site</p>
    ...
    <div className="row g-4 align-items-center py-5">
      <div className="col-md-3">
        <div className="links ms-5 d-flex flex-column gap-5">
            ...
            href="https://ahmedeid2260.github.io/BookMark/"
            role="button"
            target="_blank"
            >
            ...
            <Link
            className=" rounded rounded-circle m-1"
            href="https://github.com/ahmedeid2260/BookMark"
            role="button"
            target="_blank"
            >
      ...
      <div className="col-md-9">
        <figure className=" rounded rounded-2 overflow-hidden img">
          <Link href="https://ahmedeid2260.github.io/BookMark/" target="_blank">
          <Image src={require("../../../../assets/image/7bookmark.png")} alt="bookmark" className="w-100" />
          </Link>
        </figure>
      </div>
    </div>
