...
return <>
    <div className="objectives  my-2">
        ...
        responsive and dynamic web applications. Eager to contribute to a
        productive team to develop innovative web solutions and grow as a
    ...
    <div className="languages">
        ...
        <Link href="https://www.typescriptlang.org/" target="_blank">
            ...
            width={50}
            height={50}
            src={require("../../../assets/image/typescript.png")}
            alt="jquery"
            />
    ...
    <div className="framework">
        ...
        <Link target="_blank" href="https://getbootstrap.com/">
            <i
            style={{ color: "#7811F7" }}
            className="fa-brands fa-bootstrap fa-3x mx-2 "
            ></i>
        ...
        <Link target="_blank" href="https://jquery.com/">
            ...
            width={50}
            height={50}
            src={require("../../../assets/image/jquery.png")}
            alt="jquery"
            />
        ...
        <Link target="_blank" href="https://nextjs.org/">
            ...
            width={50}
            height={50}
            src={require("../../../assets/image/next-js-seeklogo.svg")}
            alt="jquery"
            />
    ...
    <div className="tools">
        ...
        <Link target="_blank" href="https://webpack.js.org/">
            ...
            width={50}
            height={50}
            src={require("../../../assets/image/webpack.png")}
            alt="jquery"
            />
        ...
        <Link target="_blank" href="https://www.postman.com/">
            ...
            width={50}
            height={50}
            src={require("../../../assets/image/postman.png")}
            alt="jquery"
            />
